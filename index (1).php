            ...
            <div class="col-md-12">
                <div calss="card">
                    <div class="card-header">
                        <h4>Detail Siswa
                            <a href="tambah_siswa.php" class="btn btn-primary float-end">Tambah Data Sisawa</a>
                        </h4>
                    </div>
                    <div class="card-body">
                                ...
                                foreach($query_run as $siswa)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <form action="code.php" method="POST" class="d-inline">
                                            <button type="submit" name="hapus_data_siswa" value="<?=$siswa['id'];?>" class="btn btn-danger btn-sa">Hapus Data</button>
                                        </form>
                                        </td>
                                    </tr>
                                    <?php
